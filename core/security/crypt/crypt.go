...
package crypt ;import (_a "crypto/aes";_cf "crypto/cipher";_ef "crypto/md5";_c "crypto/rand";_ea "crypto/rc4";_f "fmt";_cfg "github.com/doraemonkeys/unipdf/v3/common";_dc "github.com/doraemonkeys/unipdf/v3/core/security";_e "io";);func init (){_gege ("\u0041\u0045\u0053V\u0032",_fb )};
