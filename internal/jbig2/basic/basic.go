...
package basic ;import _c "github.com/doraemonkeys/unipdf/v3/internal/jbig2/errors";func (_ed *IntSlice )Copy ()*IntSlice {_aa :=IntSlice (make ([]int ,len (*_ed )));copy (_aa ,*_ed );return &_aa ;};type IntsMap map[uint64 ][]int ;func (_b *IntSlice )Add (v int )error {if _b ==nil {return _c .Error ("\u0049\u006e\u0074S\u006c\u0069\u0063\u0065\u002e\u0041\u0064\u0064","\u0073\u006c\u0069\u0063\u0065\u0020\u006e\u006f\u0074\u0020\u0064\u0065f\u0069\u006e\u0065\u0064");
